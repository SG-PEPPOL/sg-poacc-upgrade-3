...
|tbr01-004
|An order must provide for information about the value of items ordered and what prices, charges and totals (including estimate of GST) are expected to be paid in a way that can be matched against an invoice.
