...
|tbr01-011
|For supporting reverse charge GST invoicing the order must provide for the buyers GST number in order to enable the seller to issue legally valid invoices.
