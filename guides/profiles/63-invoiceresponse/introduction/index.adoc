...
*The purpose* of this document is to describe a common format for the Invoice Response in the European market, and to facilitate an efficient implementation and increased use of electronic collaboration regarding invoice responses based on this format.
